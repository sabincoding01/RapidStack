  ...
  return (
    <footer className="bg-zinc-950 text-zinc-400 border-t border-zinc-800/50">
      <div className="max-w-6xl mx-auto px-6 py-5">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-15 mb-5">
          
          {/* Brand */}
          <div className="md:col-span-1">
            <div className='flex flex-row items-center gap-2 mb-3'>
            <img src="src\assets\logo (1).png" className="w-15 h-15 " />
            <h2 className="text-yellow-100 text-xl font-semibold  tracking-tight flex flex-col ">
              <span className='text-green-500 text-2xl'>Eco-Vital </span>HealthCare
            </h2>
            </div>
          ...
          {/* Product */}
          <div>
            <h3 className="text-zinc-200 text-sm font-medium mb-4">Product</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="text-zinc-200 text-sm font-medium mb-4">Company</h3>
            <ul className="space-y-1">
          ...
          {/* Legal */}
          <div>
            <h3 className="text-zinc-200 text-sm font-medium mb-4">Legal</h3>
            <ul className="space-y-1">
